...
./waf configure -T release --build-game=missinginfo --android=aarch64,host,21 --target=../aarch64 -8 --disable-warns --prefix=./android/arm64-v8a &&
./waf install --target=client,server --destdir=./android/arm64-v8a -j4
