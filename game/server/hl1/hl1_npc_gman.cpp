...
class CNPC_GMan_HL1 : public CAI_BaseActor
{
	DECLARE_CLASS( CNPC_GMan_HL1, CAI_BaseActor );
public:
...
LINK_ENTITY_TO_CLASS( monster_gman, CNPC_GMan_HL1 );

//=========================================================
// Hack that tells us whether the GMan is in the final map
//=========================================================
bool CNPC_GMan_HL1::IsInC5A1()
{
...
// relationship table.
//=========================================================
Class_T	CNPC_GMan_HL1::Classify ( void )
{
	return	CLASS_NONE;
}
...
//=========================================================
void CNPC_GMan_HL1::HandleAnimEvent( animevent_t *pEvent )
{
	switch( pEvent->event )
	{
	case 1:
...
//=========================================================
int CNPC_GMan_HL1::GetSoundInterests ( void )
{
	return	NULL;
}
...
void CNPC_GMan_HL1::StartTask( const Task_t *pTask )
{
	switch( pTask->iTask )
	{
	case TASK_WAIT:
...
void CNPC_GMan_HL1::RunTask( const Task_t *pTask )
{
	switch( pTask->iTask )
	{
	case TASK_WAIT:
...
// Override all damage
//=========================================================
int CNPC_GMan_HL1::OnTakeDamage_Alive( const CTakeDamageInfo &inputInfo )
{
...
void CNPC_GMan_HL1::TraceAttack( CBaseEntity *pAttacker, float flDamage, const Vector &vecDir, trace_t *ptr, int bitsDamageType)
{
	g_pEffects->Ricochet( ptr->endpos, ptr->plane.normal );
//	AddMultiDamage( pevAttacker, this, flDamage, bitsDamageType );
}

int CNPC_GMan_HL1::PlayScriptedSentence( const char *pszSentence, float delay, float volume, soundlevel_t soundlevel, bool bConcurrent, CBaseEntity *pListener )
{
