...
LINK_ENTITY_TO_CLASS( hl1mp_monstermaker, CHL1MPNPCMaker );


//-----------------------------------------------------------------------------
// Purpose: Spawn
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::Spawn( void )
{
	SetSolid( SOLID_NONE );
	m_cLiveChildren		= 0;
	Precache();
	...
	{
		SetThink ( &CHL1MPNPCMaker::MakerThink );
...
//-----------------------------------------------------------------------------
bool CHL1MPNPCMaker::CanMakeNPC( void )
{
...
//			been created.
//-----------------------------------------------------------------------------
bool CHL1MPNPCMaker::IsDepleted()
{
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::Toggle( void )
{
	if ( m_bDisabled )
	{
		Enable();
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::Enable( void )
{
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::Disable( void )
{
	m_bDisabled = true;
	SetThink ( NULL );
}
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::InputSpawnNPC( inputdata_t &inputdata )
{
	MakeNPC();
}
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::InputEnable( inputdata_t &inputdata )
{
	Enable();
}
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::InputDisable( inputdata_t &inputdata )
{
	Disable();
}
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::InputToggle( inputdata_t &inputdata )
{
	Toggle();
}
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::Precache( void )
{
	BaseClass::Precache();
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::MakeNPC( void )
{
	if (!CanMakeNPC())
	{
		return;
...
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::MakerThink ( void )
{
	SetNextThink( gpGlobals->curtime + m_flSpawnFrequency );
...
// Input  : *pVictim - 
//-----------------------------------------------------------------------------
void CHL1MPNPCMaker::DeathNotice( CBaseEntity *pVictim )
{
