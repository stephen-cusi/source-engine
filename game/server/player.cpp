...
void CBasePlayer::CheatImpulseCommands( int iImpulse )
{
	...
	case 101:
		...
		GiveNamedItem( "weapon_bananna" );
		GiveNamedItem( "weapon_custom1" );
		GiveNamedItem( "weapon_custom2" );
		GiveNamedItem( "weapon_custom3" );
		GiveNamedItem( "weapon_custom5" );
		GiveNamedItem( "weapon_custom6" );
		GiveNamedItem( "weapon_custom9" );
		GiveNamedItem( "weapon_custom10" );
		GiveNamedItem( "weapon_custom12" );
		GiveNamedItem( "weapon_custom13" );
		GiveNamedItem( "weapon_custom15" );
		GiveNamedItem( "weapon_custom16" );
		GiveNamedItem( "weapon_custom19" );
		GiveNamedItem( "weapon_custom20" );
		GiveNamedItem( "weapon_custom23" );
		GiveNamedItem( "weapon_custom24" );
		GiveNamedItem( "weapon_custom26" );
		GiveNamedItem( "weapon_custom27" );
		GiveNamedItem( "weapon_custom29" );
		GiveNamedItem( "weapon_flamethrower" );
		GiveNamedItem( "weapon_gcrowbar" );
		GiveNamedItem( "weapon_gravgren" );
		GiveNamedItem( "weapon_lasergun" );
		GiveNamedItem( "weapon_lstick" );
		GiveNamedItem( "weapon_msbomb" );
		GiveNamedItem( "weapon_nodemaker" );
		GiveNamedItem( "weapon_psp" );
		GiveNamedItem( "weapon_scissor" );
		GiveNamedItem( "weapon_shovel" );
		GiveNamedItem( "weapon_soy" );
		GiveNamedItem( "weapon_stcannon" );
		GiveNamedItem( "weapon_svd" );
#ifdef HL2_EPISODIC
