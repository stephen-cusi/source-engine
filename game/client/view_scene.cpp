...
// Breadman
// NightVision - This came from the Valve Dev webpage regarding Night vision.
// It's probably not best practice but I'm seeing how well this works with my own textures.
// I'm putting my own spin on this by displaying a simple overlay. The rest is handled by the flashlight modifications.
// It uses a new light texture and colour, along with custom sounds.
