...
class C_WeaponGravityGunBeta : public C_BaseCombatWeapon
{
	DECLARE_CLASS( C_WeaponGravityGunBeta, C_BaseCombatWeapon );
public:
	C_WeaponGravityGunBeta() {}
...
private:
	C_WeaponGravityGunBeta( const C_WeaponGravityGunBeta& );

	C_BeamQuadratic	m_beam;
};

STUB_WEAPON_CLASS_IMPLEMENT( weapon_physgun, C_WeaponGravityGunBeta);

IMPLEMENT_CLIENTCLASS_DT( C_WeaponGravityGunBeta, DT_WeaponGravityGunBeta, CWeaponGravityGunBeta)
